export function ReconstructSection() {
  return (
    <section id="section-5" className="h-screen flex flex-col items-center justify-center text-center px-6 md:px-12 lg:px-16">
      <p className="reveal section-label mb-4">Let&apos;s Connect</p>
